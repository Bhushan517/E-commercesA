      ...
      <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-white rounded-lg p-4 shadow-sm">
          <div className="flex items-center space-x-2">
            ...
            <span className="font-medium text-gray-900">Editable Profile</span>
          </div>
          <p className="text-sm text-gray-600 mt-1">Update your personal information anytime</p>
        </div>
        ...
        <div className="bg-white rounded-lg p-4 shadow-sm">
          ...
          <p className="text-sm text-gray-600 mt-1">Manage passwords and security options</p>
        </div>
